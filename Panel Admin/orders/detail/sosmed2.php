	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_GET['oid'])) {
			...
			if (mysqli_num_rows($checkdb_order) == 0) {
				header("Location: ".$cfg_baseurl."orders/history/sosmed2");
			} else {
                ...
                <h3 class="card-title">
                                    ...
                                    <div class="card-body">
                	                    <div class="table-responsive">
						                    ...
						                    <a href="<?php echo $cfg_baseurl; ?>orders/history/sosmed2" class="btn btn-success m-b-10"><i class="fa fa-arrow-left"></i> Kembali</a>
					                    </div>
                                    </div>
                    </div>
                </div>
