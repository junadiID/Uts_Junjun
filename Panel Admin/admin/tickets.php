                ...
                <div class="col-md-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-ticket"></i> Data Tiket</h3>
                                </div>
...
?>
													<tr>
														...
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/ticket/reply.php?id=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-success btn-rounded"><i class="fa fa-reply"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/ticket/close.php?id=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-info btn-rounded"><i class="fa fa-times"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/ticket/delete.php?id=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-danger btn-rounded"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
<?php
}
