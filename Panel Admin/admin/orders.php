...
// end paging config
												...
												?>
													<tr>
														...
														<td align="center">
							<a href="<?php echo $cfg_baseurl; ?>admin/order/edit.php?oid=<?php echo $data_show['oid']; ?>" class="btn btn-xs btn-primary btn-rounded"><i class="fa fa-edit"></i></a>
                                                        <a href="<?php echo $cfg_baseurl; ?>admin/order/detail.php?oid=<?php echo $data_show['oid']; ?>" class="btn btn-xs btn-success btn-rounded"><i class="fa fa-eye"></i></a>														
														</td>
													</tr>
												<?php
												}
