                ...
                <div class="col-lg-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-comment"></i> Balas Tiket</h3>
                                </div>
...
?>
								...
								<div class="panel panel-default animated fadeInDown">
										...
										<form class="form-horizontal" role="form" method="POST">
											...
											<a href="<?php echo $cfg_baseurl; ?>admin/tickets.php" class="btn btn-warning"><i class="fa fa-refresh"></i> Kembali</a>
											<button type="submit" class="pull-right btn btn-info" name="submit"><i class="fa fa-comment"></i> Balas</button>
											</div>
										</form>
									</div>
								</div>
