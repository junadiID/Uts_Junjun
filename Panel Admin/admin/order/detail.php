...
?>
            ...
            <div class="row">
                <div class="col-md-offset-2 col-md-8"><a href="<?php echo $cfg_baseurl; ?>admin/orders.php" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali Ke Daftar</a><br /><br />
