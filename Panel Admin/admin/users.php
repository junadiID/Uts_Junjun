        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-panel widget-style-1 bg-info animated fadeInDown">
                            ...
                            <h2 class="m-0">Rp <?php echo number_format($data_wuser['total'],0,',','.'); ?> (Dari <?php echo number_format($count_wuser,0,',','.'); ?> pengguna)</h2>
                            <div> Total Seluruh Saldo Pengguna</div>
                        </div>
                    </div>
                </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-users"></i> Data Pengguna</h3>
                                </div>
                		<div class="panel-body">
									...
									<div class="row">		
										<div class="col-md-6">
											<a href="<?php echo $cfg_baseurl; ?>admin/user/add.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
										</div>
										<div class="col-md-6">
											<form method="GET">
...
// end paging config
												...
												?>
													<tr>
														...
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/user/edit.php?username=<?php echo $data_show['username']; ?>" class="btn btn-xs btn-primary btn-rounded"><i class="fa fa-edit"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/user/delete.php?username=<?php echo $data_show['username']; ?>" class="btn btn-xs btn-success btn-rounded"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
