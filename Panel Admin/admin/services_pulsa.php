                ...
                <div class="col-lg-12">
                    <div class="panel panel-default animated fadeInDown">
                		...
                		<div class="panel-body">
										...
										<div class="col-md-6">
											<a href="<?php echo $cfg_baseurl; ?>admin/service_pulsa/add.php" class="btn btn-info btn-bordred"><i class="fa fa-plus"></i> Tambah</a>
										</div>
										<div class="col-md-6">
											<form method="GET">
...
// end paging config
												...
												?>
													<tr>
														...
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/service_pulsa/detail.php?sid=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-info btn-rounded"><i class="fa fa-eye"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/service_pulsa/edit.php?sid=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-warning btn-rounded"><i class="fa fa-edit"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/service_pulsa/delete.php?sid=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-danger btn-rounded"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
