...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['create_code'])) {
            $code = create_random(7);

			if (empty($code)) {
				$msg_type = "error";
				$msg_content = "<b>Gagal:</b> Mohon mengisi semua input.";
			} else {
				$insert_code = mysqli_query($db, "INSERT INTO code_verification (date, code, status) VALUES ('$date', '$code', 'Active')");
				if ($insert_code == TRUE) {
					$msg_type = "success";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-code"></i> Data Kode Undangan</h3>
                                </div>
                		<div class="panel-body">
										...
										<div class="row">
										<div class="col-md-6">
                                <button class="btn btn-primary" type="submit" name="create_code">
                                    <i class="fa fa-plus"></i> Buat Kode Undangan
                                </button>									
                                        </div>	
                                        <div class="col-md-6">
                                        </div>
										...
										<div class="table-responsive">
											<table class="table table-bordered">
												...
												<tbody>
													<?php
													$check_deposit = mysqli_query($db, "SELECT * FROM code_verification ORDER BY id DESC");
													$no = 1;
