	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['delete'])) {
			...
			if (mysqli_num_rows($checkdb_news) == 0) {
				$msg_type = "error";
				$msg_content = "<b>Gagal:</b> Informasi tidak ditemukan.";
			} else {
				$delete_news = mysqli_query($db, "DELETE FROM news WHERE id = '$post_id'");
				if ($delete_news == TRUE) {
					$msg_type = "success";
					$msg_content = "<b>Berhasil:</b> Informasi telah dihapus...";
				}
			}
		}
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-warning"></i> Data Informasi</h3>
                                </div>
                		<div class="panel-body">
										...
										?>
								<a href="<?php echo $cfg_baseurl; ?>admin/information/add.php" class="btn btn-info btn-bordred m-b-20"><i class="fa fa-plus"></i> Tambah Berita </a>
...
// end paging config
												...
												?>
													<tr>
														...
														<td><?php echo $data_show['section']; ?></td>
														<td><?php echo nl2br($data_show['content']); ?></td>
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/information/edit.php?id=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-warning"><i class="fa fa-edit"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/information/delete?id=<?php echo $data_show['id']; ?>" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												$no++;
