...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_POST['delete'])) {
			$post_sid = $_POST['sid'];
			$checkdb_service = mysqli_query($db, "SELECT * FROM servicess WHERE sid = '$post_sid'");
			if (mysqli_num_rows($checkdb_service) == 0) {
				$msg_type = "error";
				$msg_content = "<b>Gagal:</b> Layanan tidak ditemukan.";
			} else {
				$delete_user = mysqli_query($db, "DELETE FROM servicess WHERE sid = '$post_sid'");
				if ($delete_user == TRUE) {
					$msg_type = "success";
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-tags"></i> Data Layanan</h3>
                                </div>
                		<div class="panel-body">
											...
											<div class="row">
										<div class="col-md-6">
											<a href="<?php echo $cfg_baseurl; ?>admin/servicee/add.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
										</div>
										<div class="col-md-6">
											<form method="GET">
...
if (isset($_GET['search'])) {
	$search = $_GET['search'];
	$query_list = "SELECT * FROM servicess WHERE service LIKE '%$search%' ORDER BY sid ASC"; // edit
} else {
	$query_list = "SELECT * FROM servicess ORDER BY sid ASC"; // edit
}
...
// end paging config
												...
												?>
													<tr>
														...
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/servicee/detail.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-info btn-rounded"><i class="fa fa-eye"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/servicee/edit.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-warning btn-rounded"><i class="fa fa-edit"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/servicee/delete.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-danger btn-rounded"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
