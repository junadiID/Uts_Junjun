                ...
                <div class="col-lg-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-edit"></i> Ubah Pengguna</h3>
                                </div>
                		<div class="panel-body">
										...
										<form class="form-horizontal" role="form" method="POST">
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<input type="text" name="email" class="form-control" placeholder="Email" value="<?php echo $datadb_user['email']; ?>">
												</div>
											</div>
											<div class="form-group">
