        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="widget-panel widget-style-1 bg-info animated fadeInDown">
                            ...
                            <h2 class="m-0">Rp <?php echo number_format($data_wtransfer['total'],0,',','.'); ?></h2>
                            <div> Total Seluruh Transfer Saldo</div>
                        </div>
                    </div>
                </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-money"></i> Data Riwayat Transfer</h3>
                                </div>
