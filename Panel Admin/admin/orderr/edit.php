	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		if (isset($_GET['oid'])) {
			...
			if (mysqli_num_rows($checkdb_order) == 0) {
				header("Location: ".$cfg_baseurl."admin/orderss.php");
				...
				if (isset($_POST['edit'])) {
					...
					if ($post_status != "Pending" AND $post_status != "Processing" AND $post_status != "Error" AND $post_status != "Partial" AND $post_status != "Success") {
						...
						$update_order = mysqli_query($db, "UPDATE orderss SET start_count = '$post_start', remains = '$post_remains', status = '$post_status' WHERE oid = '$post_oid'");
                ...
                <div class="col-md-offset-2 col-md-8">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-edit"></i> Ubah Data Pembelian</h3>
                                </div>
                		<div class="panel-body">
										...
										<form class="form-horizontal" role="form" method="POST">
											...
											<a href="<?php echo $cfg_baseurl; ?>admin/orderss.php" class="btn btn-warning"><i class="fa fa-refresh"></i> Kembali </a>												
											    </div>
											</div>
										</form>
									</div>
...
<?php
			...
			header("Location: ".$cfg_baseurl."admin/orderr/edit.php");
		}
	}
} else {
	header("Location: ".$cfg_baseurl);
