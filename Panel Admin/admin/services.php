                ...
                <div class="col-lg-12">
                    <div class="panel panel-default animated fadeInDown">
                		...
                		<div class="panel-body">
											...
											<div class="row">
										<div class="col-md-6">
											<a href="<?php echo $cfg_baseurl; ?>admin/service/add.php" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah</a>
										</div>
										<div class="col-md-6">
											<form method="GET">
...
// end paging config
												...
												?>
													<tr>
														...
														<td align="center">
														<a href="<?php echo $cfg_baseurl; ?>admin/service/detail.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-info btn-rounded"><i class="fa fa-eye"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/service/edit.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-warning btn-rounded"><i class="fa fa-edit"></i></a>
														<a href="<?php echo $cfg_baseurl; ?>admin/service/delete.php?sid=<?php echo $data_show['sid']; ?>" class="btn btn-xs btn-danger btn-rounded"><i class="fa fa-trash"></i></a>
														</td>
													</tr>
												<?php
												}
