...
?>
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-ticket"></i> Buat Tiket</h3>
                                </div>
                				<div class="panel-body">
										...
										<form class="form-horizontal" role="form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
											...
											<div class="form-group">
												...
												<div class="col-md-10">
													<textarea class="ckeditor" id="ckedtor" name="message"></textarea>
												</div>
											</div>
											<div class="form-group">
                ...
                <div class="col-md-5">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-history"></i> Riwayat Tiket</h3>
                                </div>
                				<div class="panel-body">
...
?>
													<tr>
														<td colspan="3">Riwayat tidak ditemukan</td>
													</tr>
<?php
} else {
...
?>
													<tr>
														<td><?php if($data_show['seen_user'] == 0) { ?><label class="label label-warning">NEW!</label><?php } ?> <a href="<?php echo $cfg_baseurl; ?>tickets/open?id=<?php echo $data_show['id']; ?>"><?php echo $data_show['subject']; ?></a></td>
