...
?>
									...
									<div class="panel panel-default animated fadeInDown">
										...
										<form class="form-horizontal" role="form" method="POST">
											...
											<a href="<?php echo $cfg_baseurl; ?>tickets/new" class="btn btn-default"><i class="fa fa-refresh"></i> Kembali</a>
											<button type="submit" class="pull-right btn btn-primary" name="submit"><i class="fa fa-send"></i> Balas</button>
											</div>
										</form>
									</div>
								</div>
