...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		$post_balance = $cfg_member_bonus; // bonus member
		$post_price = $cfg_member_price; // price member for registrant
		if (isset($_POST['add'])) {
			...
			if (empty($post_username) || empty($post_password)) {
				...
				$msg_type = "error";
				$msg_content = "<b>Gagal:</b> Username <b>$post_username</b> sudah terdaftar dalam database.";
				...
				$insert_user = mysqli_query($db, "INSERT INTO users (fullname, username, password, balance, level, registered, status, api_key, email, uplink) VALUES ('$post_fullname', '$post_username', '$post_password', '$post_balance', 'Member', '$date', 'Active', '$post_api', '$post_email', '$sess_username')");
				if ($insert_user == TRUE) {
					$msg_type = "success";
					$msg_content = "<b>Berhasil:</b> Member telah ditambahkan.<br /><b>Username:</b> $post_username<br /><b>Password:</b> $post_password<br /><b>Level:</b> Member<br /><b>Saldo:</b> Rp ".number_format($post_balance,0,',','.');
				} else {
					$msg_type = "error";
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-user-plus"></i> Tambah Member</h3>
                                </div>
                ...
                <div class="col-md-5">
                    <div class="panel panel-default animated fadeInDown">
                		...
                		<div class="panel-body">
                                    	<ul>
                                    		<li>Pastikan saldo anda cukup untuk melakukan pendaftaran Member.</li>
                                    		<li>Saldo Anda terpotong Rp <?php echo number_format($post_price,0,',','.'); ?> untuk 1x pendaftaran Member.</li>
                                    		<li>Member baru akan mendapat saldo Rp. <?php echo number_format($post_balance,0,',','.'); ?>.</li><hr>
