            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-money"></i> Transfer Saldo</h3>
                                </div>
                ...
                <div class="col-md-5">
                    <div class="panel panel-default animated fadeInDown">
                		...
                		<div class="panel-body">
                                    	<ul>
                                    		<li>Pastikan saldo anda cukup untuk melakukan transfer saldo.</li>
                                    		<li>Saldo Anda akan dipotong sesuai jumlah transfer saldo.</li>
                                    		<li>Minimal transfer Rp <?php echo number_format($cfg_min_transfer,0,',','.'); ?>.</li><hr>
