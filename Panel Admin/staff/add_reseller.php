...
if (isset($_SESSION['user'])) {
	...
	if (mysqli_num_rows($check_user) == 0) {
		...
		header("Location: ".$cfg_baseurl."account/logout");
	} else if ($data_user['level'] == "Reseller" OR $data_user['level'] == "Agen"  OR $data_user['level'] == "Member") {
            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="panel panel-default animated fadeInDown">
                        <div class="panel-heading">
                           <h3 class="panel-title"><i class="fa fa-user-plus"></i> Tambah Reseller</h3>
                                </div>
                ...
                <div class="col-md-5">
                    <div class="panel panel-default animated fadeInDown">
                		...
                		<div class="panel-body">
                                    	<ul>
                                    		<li>Pastikan saldo anda cukup untuk melakukan pendaftaran Reseller.</li>
                                    		<li>Saldo Anda terpotong Rp <?php echo number_format($post_price,0,',','.'); ?> untuk 1x pendaftaran Reseller.</li>
                                    		<li>Reseller baru akan mendapat saldo Rp. <?php echo number_format($post_balance,0,',','.'); ?>.</li><hr>
